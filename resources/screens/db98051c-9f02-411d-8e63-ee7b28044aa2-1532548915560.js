jQuery("#simulation")
  .on("click", ".s-db98051c-9f02-411d-8e63-ee7b28044aa2 .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-db98051c-9f02-411d-8e63-ee7b28044aa2")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/fa0de845-6774-40e3-8e3b-c13d220217c9"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("change", ".s-db98051c-9f02-411d-8e63-ee7b28044aa2 .change", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("mouseenter dragenter", ".s-db98051c-9f02-411d-8e63-ee7b28044aa2 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
          ...
          "blocks": [
            {
              ...
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": [ {
                    "#s-db98051c-9f02-411d-8e63-ee7b28044aa2 #s-option1_2 span": {
                      "attributes": {
                        "color": "#434343"
                      }
                    }
                  },{
                    "#s-db98051c-9f02-411d-8e63-ee7b28044aa2 #s-option4_1 span": {
                      "attributes": {
                        "color": "#434343"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-db98051c-9f02-411d-8e63-ee7b28044aa2 #s-option3_2 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-db98051c-9f02-411d-8e63-ee7b28044aa2 #s-option1_1 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-db98051c-9f02-411d-8e63-ee7b28044aa2 #s-Text_cell_2 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-db98051c-9f02-411d-8e63-ee7b28044aa2 #s-Text_cell_4 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
  ...
  .on("mouseleave dragleave", ".s-db98051c-9f02-411d-8e63-ee7b28044aa2 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
