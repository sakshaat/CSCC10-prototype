jQuery("#simulation")
  .on("click", ".s-09276eba-15b1-4036-bd0a-633be5d75b0c .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-09276eba-15b1-4036-bd0a-633be5d75b0c .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
          ...
          "blocks": [
            {
              ...
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": [ {
                    "#s-09276eba-15b1-4036-bd0a-633be5d75b0c #s-option4_1 span": {
                      "attributes": {
                        "color": "#434343"
                      }
                    }
                  },{
                    "#s-09276eba-15b1-4036-bd0a-633be5d75b0c #s-option1_2 span": {
                      "attributes": {
                        "color": "#434343"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-09276eba-15b1-4036-bd0a-633be5d75b0c #s-option3_2 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-09276eba-15b1-4036-bd0a-633be5d75b0c #s-option1_1 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-09276eba-15b1-4036-bd0a-633be5d75b0c #s-Text_cell_2 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-09276eba-15b1-4036-bd0a-633be5d75b0c #s-Text_cell_4 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-09276eba-15b1-4036-bd0a-633be5d75b0c #s-Label_37": {
                      "attributes": {
                        "font-size": "11.0pt",
                    ...
                    "#s-09276eba-15b1-4036-bd0a-633be5d75b0c #s-Label_37 .valign": {
                      "attributes": {
                    ...
                    "#s-09276eba-15b1-4036-bd0a-633be5d75b0c #s-Label_37 span": {
                      "attributes": {
                        "color": "#005580",
                        "text-align": "center",
  ...
  .on("mouseleave dragleave", ".s-09276eba-15b1-4036-bd0a-633be5d75b0c .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
