jQuery("#simulation")
  .on("click", ".s-d183f124-3a88-47f7-bf75-25f2dfbfe6bc .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-d183f124-3a88-47f7-bf75-25f2dfbfe6bc .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
          ...
          "blocks": [
            {
              ...
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": [ {
                    "#s-d183f124-3a88-47f7-bf75-25f2dfbfe6bc #s-option4_1 span": {
                      "attributes": {
                        "color": "#434343"
                      }
                    }
                  },{
                    "#s-d183f124-3a88-47f7-bf75-25f2dfbfe6bc #s-option1_2 span": {
                      "attributes": {
                        "color": "#434343"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-d183f124-3a88-47f7-bf75-25f2dfbfe6bc #s-option3_2 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-d183f124-3a88-47f7-bf75-25f2dfbfe6bc #s-option1_1 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-d183f124-3a88-47f7-bf75-25f2dfbfe6bc #s-Text_cell_2 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-d183f124-3a88-47f7-bf75-25f2dfbfe6bc #s-Text_cell_4 span": {
                      "attributes": {
                        "color": "#21C0C0"
                      }
                    }
  ...
  .on("mouseleave dragleave", ".s-d183f124-3a88-47f7-bf75-25f2dfbfe6bc .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
  ...
  .on("windowresize", ".s-d183f124-3a88-47f7-bf75-25f2dfbfe6bc .windowresize", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-d183f124-3a88-47f7-bf75-25f2dfbfe6bc")) {
      cases = [
        {
          "blocks": [
            {
